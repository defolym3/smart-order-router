import { MixedRouteSDK, Protocol, SwapRouter as SwapRouter02, Trade } from '@defolym3/router-sdk';
import { ChainId, Currency, TradeType } from '@defolym3/sdk-core';
import { SwapRouter as UniveralRouter, UNIVERSAL_ROUTER_ADDRESS } from '@defolym3/universal-router-sdk';
import { Route as V2RouteRaw } from '@defolym3/v2-sdk';
import { Route as V3RouteRaw } from '@defolym3/v3-sdk2';
